...
int ap_rank_eth(const ap_info_t *rec_a, const ap_info_t *rec_b);
...
void ap_sortap(twl_list_t *, int);
void ap_sorteth(twl_list_t *, int);
...
void ap_appendq(twl_list_t *, int, int);
